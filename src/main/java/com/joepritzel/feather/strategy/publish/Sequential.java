...
/**
 * This publish strategy runs everything on the thread that calls the publish
 * method.
 * 
 * @author Joe Pritzel
 * 
 */
public class Sequential implements PublishStrategy {
	 ...
	 */
	public Sequential(boolean considerHierarchy) {
